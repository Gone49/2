...
export default function Page() {
  ...
  const [isViewMore, setIsViewMore] = useState(false); // Toggle for view more or less
  ...
  const handleFilterChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    if (selectedTreatment === '') {
      ...
      setVisiblePatients(filteredPatients.slice(0, 10)); // Reset visible list for the filtered patients
    }
  };
