      ...
      <div className="max-w-xl w-full bg-white shadow-lg rounded-lg p-8">
        ...
        {!submitted ? (
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-cyan-500 to-cyan-600 text-white font-semibold py-3 rounded-lg shadow-lg hover:from-blue-600 hover:to-blue-700 transition duration-300"
            >
              Submit Feedback
            </button>
          </form>
          ...
          <div className="text-center space-y-4">
            ...
            <button
              ...
              className="px-6 py-2 bg-gradient-to-r from-cyan-500 to-cyan-600 text-white font-semibold rounded-lg shadow-lg hover:from-blue-600 hover:to-blue-700 transition duration-300"
            >
