...
import 'react-time-picker/dist/re'
      ...
      <div className="w-full bg-white shadow-md rounded-lg p-6">
        ...
        <div>
          ...
          <TimePicker
            ...
            value={selectedTime}
            className="border-2 p-3 rounded-lg w-full bg-white text-black focus:outline-none focus:ring-2 focus:ring-blue-600" // Improved styling
          />
        </div>
      </div>
    </div>
