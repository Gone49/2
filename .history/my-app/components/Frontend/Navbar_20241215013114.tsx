        ...
        <>
          ...
          <div className="fixed top-0 left-0 h-full w-64 bg-gray-800 text-white p-4 z-50 flex flex-col justify-between">
            ...
            <div className="mt-auto">
              <Link
                href="/doctorsSignup"
                className="block w-full text-center text-gray-800 bg-orange-300 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 rounded-lg px-4"
              >
                Become a Certified Healthcare Provider
              </Link>
            </div>
            {/* Logout Button */}
            <div className="mt-auto">
