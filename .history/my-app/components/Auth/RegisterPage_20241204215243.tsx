...
import { LoginInputProps, RegisterInputProps } from "@/type/types"; // Ensure you are using the correct type for registration
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mb-3">
            ...
            <select
              ...
              {...register("UserRole", { required: "Role is required" })} // Map to the "role" field in RegisterInputProps
            >
