  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center py-10 px-4">
      ...
      <div className="text-center mb-8">
        <h1 className="text-4xl font-extrabold text-blue-600 md:text-5xl">Welcome to a New Era in Healthcare</h1>
        <p className="mt-2 text-lg text-gray-700 md:text-xl">Where healthcare meets innovation and every decision drives progression.</p>
      </div>

      {/* Vision Section */}
      <section className="bg-white p-6 rounded-lg shadow-lg w-full md:w-3/4 lg:w-1/2 text-center mb-8">
        <blockquote className="text-lg italic text-gray-800 md:text-xl">
          "In the future of healthcare, collaboration not competition , drives the change. Every connection counts and every action improves lives." <br />
          <span className="font-semibold">- Our Vision</span>
        </blockquote>
      </section>

      {/* About Our Mission */}
      <div className="bg-white p-8 rounded-lg shadow-md w-full md:w-3/4 lg:w-1/2 mb-8">
