      ...
      <div className="max-w-screen-xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 relative">
            {/* "Most Popular" tag */}
            <span className="absolute top-[-16px] left-1/2 transform -translate-x-1/2 bg-cyan-400 text-white text-xs font-semibold px-4 py-1 rounded-md border-4 border-white">
              Most Popular
            </span>
