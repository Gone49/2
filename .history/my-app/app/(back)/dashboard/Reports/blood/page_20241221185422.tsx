              ...
              <div key={report.id} className="border p-4 rounded-lg shadow-md">
                ...
                <div className="mt-4 text-center">
                  <button 
                    ...
                    className="px-6 py-2 bg-gradient-to-r from-gray-300 to-gray-200 text-white font-semibold rounded-lg shadow-lg hover:from-red-600 hover:to-red-700 transition duration-300"
                  >
                    View Report
                  </button>
                </div>
