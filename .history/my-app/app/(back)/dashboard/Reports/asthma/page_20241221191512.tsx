...
export default function AsthmaReportsPage() {
  ...
  useEffect(() => {
    // Filter reports by category "Asthma" and sort them by latest date and time
  ...
  const handleDateChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (selectedDateValue) {
      ...
      const filteredByDate = reports.filter((report) => {
        ...
        return reportDateString === selectedDateValue && report.category === 'Asthma';
      });
      setFilteredReports(sortReportsByDate(filteredByDate)); // Sort by latest date and time
    } else {
      // If no date is selected, show all reports
      const asthmaReports = reports.filter(report => report.category === 'Asthma');
      setFilteredReports(sortReportsByDate(asthmaReports)); // Sort by latest date and time
    }
  };
