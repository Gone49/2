    ...
    <div>
      ...
      <div className="mb-4 relative">
        ...
        <button
          ...
          className="border px-4 py-1 flex items-center"
        >
          <span className="mr-2">Choose Treatment</span>
          <span
            className={`arrow ${isOpen ? 'rotate' : ''} transform transition-transform duration-300`}
          >
            ▼
          </span>
        </button>
        {isOpen && (
          <select
            id="filter"
            className="border px-4 py-1 absolute mt-2"
            value={filter}
