...
const Dashboard = () => {
  ...
  return (
    <><div className="w-full md:w-1/3 mt-5 mx-auto">
          ...
          {error && <p className="text-red-500 text-sm mt-2 pl-4">{error}</p>}
      </div><div className="w-full md:w-1/2 bg-white p-4 shadow-lg rounded-lg ml-4">
              ...
              <button
                  ...
                  className="bg-cyan-500 hover:bg-cyan-600 text-white rounded-md px-4 py-2 block mx-auto"
              >
                  View All
              </button>
          </div></>
