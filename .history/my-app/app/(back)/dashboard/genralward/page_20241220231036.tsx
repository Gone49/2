    ...
    <div className="p-6 bg-gray-50">
      ...
      <div className="mb-6 flex items-center gap-6">
        ...
        <button
          ...
          className="ml-4 px-4 py-2 bg-gray-300 text-white rounded-md hover:bg-gray-600 transition duration-200"
        >
          Clear Filters
        </button>
      </div>
      ...
      <div className="grid gap-6">
        {filteredPatients.length > 0 ? (
          filteredPatients.map((patient) => (
            <div
              key={patient.id}
              className="border rounded-lg shadow-lg bg-white p-6 flex flex-col space-y-4"
            >
