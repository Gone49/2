...
const Navbar: React.FC = () => {
  ...
  <div className="flex-shrink-0 rounded-full bg-cyan-500 text-white h-10 w-10 flex items-center justify-center shadow-lg">
    <span className="font-bold text-lg">CB</span>
  </div>
  <h1 className="font-serif font-thin text-2xl text-gray-800 hover:text-cyan-500 transition-colors">
    CareBridge
  </h1>
</Link>
