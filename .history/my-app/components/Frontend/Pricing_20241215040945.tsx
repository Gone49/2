  ...
  return (
    <div className="min-h-screen bg-teal-50 py-10 px-4 rounded-lg">
      <div className="max-w-screen-xl mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center lg:flex-row lg:space-x-6 gap-6">
          {plans.map((plan, index) => (
            <div
              key={index}
              className={`bg-white p-6 rounded-lg shadow-md border border-gray-200 relative w-full sm:w-96 lg:w-[30%] ${
