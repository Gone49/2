...
const Navbar: React.FC = () => {
  ...
  <h1 className="text-4xl font-serif font-extrabold tracking-tight text-gray-900 group-hover:text-cyan-600 transition-colors">
    <span className="bg-gradient-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent">
      Care
    </span>
    <span className="text-gray-800 group-hover:text-cyan-500">Bridge</span>
  </h1>
</Link>
