...
const DoctorSignUpPage = () => {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center py-10 px-4">
      ...
      {/* Call to Action */}
      <div className="bg-gradient-to-r from-teal-100 via-blue-200 to-purple-300 p-8 rounded-lg shadow-xl w-full md:w-3/4 lg:w-1/2 mb-8 flex flex-col items-center text-center">
