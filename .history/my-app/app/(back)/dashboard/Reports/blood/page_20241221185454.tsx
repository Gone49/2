              ...
              <div key={report.id} className="border p-4 rounded-lg shadow-md">
                ...
                <div className="mt-4 text-center">
                  <button 
                    ...
                    className="px-6 py-2 bg-gradient-to-r from-gray-300 to-gray-200 text-black font-semibold rounded-lg shadow-lg hover:from-gray-300 hover:to-gray-700 transition duration-300"
                  >
                    View Report
                  </button>
                </div>
