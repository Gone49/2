...
export async function createUser(formData: RegisterInputProps) {
  const resend = new Resend('re_YdhGepDw_N3yGtaKyjP1obaJ9cghvHuCj'); // Use API key from the environment variable
  ...
  try {
    ...
    const message =
      "Thank you for registering with CareBr. To complete your registration and verify your email address, please enter the following 6-digit verification code on our website:";
