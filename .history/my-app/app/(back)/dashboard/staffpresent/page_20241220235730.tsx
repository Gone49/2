...
export default function Page() {
  ...
  const filteredStaff = staff.filter((member) => {
    if (filterDate) {
      return member.lastUpdated === filterDate;
    }
    return member.lastUpdated === todayFormatted || member.lastUpdated === yesterdayFormatted;
  });
  ...
  return (
    <div>
      <h1 className="text-xl font-bold mb-4">Staff recent Attendence</h1>
