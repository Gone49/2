      ...
      <div className="w-full bg-white shadow-md rounded-lg p-6">
        ...
        <div className="mb-4">
          ...
          <DatePicker
            ...
            className="text-gray-600 hover:bg-blue-100" // Custom styling for day cells
          />
        </div>
        ...
        <div>
          ...
          <TimePicker
            ...
            value={selectedTime}
            className="border-2 p-4 rounded-lg w-full bg-white text-black text-xl focus:outline-none focus:ring-2 focus:ring-blue-600" // Larger padding and font size
          />
        </div>
      </div>
    </div>
