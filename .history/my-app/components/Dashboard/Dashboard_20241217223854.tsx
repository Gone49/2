...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-row items-start justify-center gap-8 mt-5 mx-auto">
      ...
      <div className="w-full md:w-1/3 bg-white p-4 shadow-lg rounded-lg mr-96 mt-4 ">
      ...
      <div className="w-full md:w-1/4 bg-white -mt-8 p-3 shadow-lg rounded-lg">
    ...
    {/* Features Section */}
    <div className="flex-grow flex bottom-0 justify-center pb-4">
