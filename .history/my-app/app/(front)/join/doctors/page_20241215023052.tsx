...
<section className="bg-white p-6 rounded-lg shadow-lg w-full md:w-3/4 lg:w-1/2 text-center mb-8">
  <blockquote className="text-lg italic text-gray-800 md:text-xl">
    "The future of healthcare lies not in individual efforts, but in the strength of collaboration. Every patient, every colleague, every connection has the power to improve lives and reshape outcomes for the better." <br />
