...
type Patient = {
  ...
  treatment: string;
  description: string;
  lastUpdated: string; // Field for the time the report was updated
};
...
const patientsData: Patient[] = [
  {
    ...
    lastUpdated: "2024-12-18 10:30 AM",
  },
  {
    id: 2,
    name: "Jane Smith",
          ...
          >
            ...
            <div className="flex-grow">
              ...
              <a
                ...
                className="text-blue-500 hover:underline font-medium max-w-screen-sm"
              >
                View Reports
              </a>
