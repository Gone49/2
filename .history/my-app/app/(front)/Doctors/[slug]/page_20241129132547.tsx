      ...
      <div className="w-full bg-white shadow-md rounded-lg p-6">
        ...
        <div>
          ...
          <TimePicker
            ...
            value={selectedTime}
            className="border-2 p-4 rounded-lg w-full bg-white text-black text-2xl focus:outline-none focus:ring-2 focus:ring-blue-600" // Larger padding and font size
          />
        </div>
      </div>
    </div>
