...
const RegisterPage = ({ role = "Patient" }: { role: any }) => {
  ...
  async function onSubmit(data: RegisterInputProps) {
    ...
    // Ensure the role is either user-selected or falls back to the default
    ...
    try {
      ...
      if (response.user) {
        console.log("User Created:", response.user); // Log user data
        console.log("Generated Token:", response.token); // Log generated token
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mb-3">
            ...
            <select
              ...
              defaultValue={role} // Set the default role
            >
