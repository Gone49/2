...
const LoginPage = () => {
  ...
  const [setShowNotification, setIsSubmitting] = useState(false);
...
export default LoginPage;
  ...
  function signIn(arg0: string, arg1: { redirect: boolean; userId: string; role: import(".prisma/client").UserRole; password: string; }) {
    throw new Error("Function not implemented.");
  }
