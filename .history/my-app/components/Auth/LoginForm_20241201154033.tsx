    ...
    <div className="min-h-screen flex items-center justify-center relative">
      ...
      <div className="relative z-60 bg-white/95 p-6 rounded-xl shadow-lg backdrop-blur-sm max-w-sm w-full lg:max-w-md lg:backdrop-blur-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <TextInput id="userId" label="User ID" placeholder="Enter your User ID" type="text" register={register} error={errors.userId?.message} />
          
          <div className="mb-3">
            <label htmlFor="role" className="block text-gray-700 font-medium text-sm mb-1">Select Your Role</label>
            <select id="role" className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:outline-none" {...register("role", { required: "Role is required" })}>
          ...
          <TextInput id="password" label="Password" placeholder="Enter your password" type="password" register={register
