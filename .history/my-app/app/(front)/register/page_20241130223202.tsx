UserActivationimport React, { useEffect, useState } from "react";

const RegisterPage = () => {
  const [userId, setUserId] = useState("");

  // Simulate fetching auto-generated ID from backend
  useEffect(() => {
    async function fetchGeneratedID() {
      const response = await fetch("/api/generate-id"); // Replace with your API
