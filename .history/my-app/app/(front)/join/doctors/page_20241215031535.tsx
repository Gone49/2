...
const DoctorSignUpPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-gray-50 to-blue-100 flex flex-col items-center py-10 px-4">
      {/* Welcome Header */}
      ...
      <div className="bg-teal-50 p-8 rounded-lg shadow-md w-full md:w-3/4 lg:w-1/2 mb-8">
        <h2 className="text-2xl font-semibold text-gray-700 text-center mb-4 md:text-3xl">
          Restructuring the Healthcare Wider
        </h2>
      ...
      <div className="bg-gradient-to-r from-teal-200 via-blue-300 to-purple-400 p-6 md:p-8 rounded-lg shadow-xl w-full md:w-3/4 lg:w-1/2 mb-8 flex flex-col items-center text-center">
        ...
        <a
          href=""/register?role='DOCTOR' " // Replace with the actual link to your signup form
      ...
      <div className="mt-8 text-center">
        <p className="text-gray-700">
          Already a member?{" "}
          <a href="/register?role='DOCTOR' " className="text-teal-500 hover:underline">
            Login here
          </a>
          .
        </p>
