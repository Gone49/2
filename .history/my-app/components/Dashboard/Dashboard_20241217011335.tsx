    ...
    <div>
      ...
      <div className="flex justify-center mx-4 mt-2">
        ...
        <div className="w-full md:w-1/4 bg-white p-4 shadow-lg rounded-lg ml-2 mr-20">
          ...
          {/* Search Bar in the middle of the Appointments section */}
          <div className="flex justify-center mb-4">
            <input
              type="text"
              placeholder="Search Appointments"
              className="bg-gray-200 p-2 rounded-lg w-2/3"
            />
          </div>
      ...
      <div className="mt-8 pb-4">
        <div className="grid grid-cols-6 gap-4 max-w-6xl w-full mx-auto">
          ...
          {[
            ...
            <div
              key={index}
              className="bg-cyan-100 p-4 text-right flex justify-center items-center"
            >
              <NavLink to={feature.path} className="text-xl">
                {feature.name}
              </NavLink>
            </div>
          ))}
