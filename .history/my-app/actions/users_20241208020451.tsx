...
export async function createUser(formData: RegisterInputProps) {
  const resend = new Resend(process.env.RESEND_API_KEY); // Use API key from the environment variable
  ...
  try {
    ...
    const sendMail = await resend.emails.send({
      from: "CareBridge <info@carebridgesupport.com>", // Update this with your verified email address
      to: email,
