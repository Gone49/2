...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative">
      ...
      <div
        className="absolute inset-0 bg-cover bg-center filter lg:blur-0 blur-sm md:blur-sm sm:blur-none hidden lg:block"
        style={{
      ...
      <div className="relative z-10 bg-white/95 p-6 rounded-xl shadow-lg backdrop-blur-sm max-w-sm w-full lg:max-w-md lg:backdrop-blur-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mb-3">
            ...
            {errors.role && <span className="text-red-500 text-sm"></span>}
          </div>
