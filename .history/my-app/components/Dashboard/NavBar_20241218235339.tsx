              ...
              {activeDropdown === "status" && (
                <div className="absolute w-40 bg-gray-200 text-gray-700 border border-gray-200">
                  <div className="relative group">
                    <Link href="/dashboard/active" className="block px-2 hover:bg-gray-100">
                      Active Treatment
                    </Link>
                    <div className="absolute left-full top-0 w-28 bg-gray-200 text-gray-700 hidden group-hover:block">
                      ...
                      <Link href="/dashboard/active/Treatnment" className="block px-1 hover:bg-gray-100">
                        ICU
                      </Link>
                    </div>
                  </div>
                  <Link href="/Status" className="block px-2 hover:bg-gray-100">
                    Discharged
                  </Link>
