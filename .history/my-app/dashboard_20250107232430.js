...
// const LoGo =
//   "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTUwHbD-7-lgM10wsZ4BO8xsaM6anNQY4imtqcNWzF2iangzbtABIdT&usqp=CAE&s";
...
//       appointmentRef.current && !appointmentRef.current.contains(event.target) &&
//       staffRef.current && !staffRef.current.contains(event.target) &&
//       reportsRef.current && !reportsRef.current.contains(event.target) &&
...
//           <Image src={LoGo} className="mr-3 h-12" alt="Logo" />
...
//           {/* Desktop Navigation */}
//           <ul className={`flex space-x-6 font-medium ${isMobileMenuOpen ? "flex-col space-y-4 absolute top-16 left-0 w-full bg-cyan-500 lg:hidden" : "space-x-6"}`}>
//             <li>
//               <Link
//                 href="/"
...
// <div> <nav className="bg-cyan-400 shadow sticky z-50 slide-in-from-top-3">
// <div className="flex items-center justify-between ">
